...
def init():
    ...
    cv2.createTrackbar('dilate_iters', 'BARS', 0, 20, do_nothing)
    cv2.createTrackbar('erode_iters', 'BARS', 0, 20, do_nothing)
...
def main():
    ...
    while True:
        ...
        edged = cv2.dilate(edged, None, iterations=cv2.getTrackbarPos('dilate_iters', 'BARS'))
        edged = cv2.erode(edged, None, iterations=cv2.getTrackbarPos('erode_iters', 'BARS'))
